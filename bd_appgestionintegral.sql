...
CREATE TABLE `Reportes` (
  `id_reporte` varchar(5) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB DEFAULT  AUTO_INCREMENT=3 CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Reportes` VALUES ('0001','789','reporte de clases','ud debe presentar mensualmente el reporte de las clases');
